        ...
        while True:
            ...
            if detected_object:
                ...
                if detected_object["x_centre"] > detected_object["image_width"] // 2:
                    ...
                    order = self.create_order(self.symbol, 0.0001, "buy")
                else:
                    print("Object on the left: Placing a SELL order.")
                    order = self.create_order(self.symbol, 0.0001, "sell")
...
if __name__ == "__main__":
    ...
    ALPACA_CONFIG = {
        "API_KEY": "PKQHRGHFMACX74FFDMI6",
        "API_SECRET": "vw6qxNjL48O9agFiSf1g6GUfqIgt9dJijGkTLfvW",
